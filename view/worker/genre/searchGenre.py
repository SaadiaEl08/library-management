...
from view.worker.genre.showInfo import ShowInfo
class Parent:
    def __init__(self,win):
        ...
        self.win.title("Search Genre by name")
...
class ByName(Parent):
    def __init__(self,win):
        super().__init__(win)
        #search----------------------------------------
        self.searchLb=CTkLabel(self.backFrame,text="Search Genre by name",font=("Baskerville",30,"bold"),pady=40,text_color="#FFD700")
        ...
        #widgets------------------------------
        label=CTkLabel(self.frame,text="Entre the Genre name",font=("Baskerville",18),pady=10 ,text_color="#FFD700")
        self.name=StringVar()
        ...
        btn=CTkButton(self.frame,text="Search",command=lambda:ShowInfo(win,self.name.get()),font=("Baskerville",18),corner_radius=20,border_width=0,hover_color="white",fg_color="#FFD700",text_color="#04042E")
        #place---------------------------------------------------
        label.pack()
        entry.pack()
        btn.pack(pady=20)