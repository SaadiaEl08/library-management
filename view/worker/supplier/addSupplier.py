...
from controler.worker.supplier.addSupplier import addSupplier
class Add:
      def __init__(self,win):
        ...
        #ADD----------------------------------------
        self.addLb=CTkLabel(self.backFrame,text="Add Supplier",font=("Baskerville",30,"bold"),pady=40,text_color="#FFD700")
        ...
        #Add btn-----------------------------------------------------------------------------
        self.ADDBTN=CTkButton(self.frame,text="Add Supplier",command=self.validateInfo,font=("Baskerville",18),corner_radius=20,border_width=0,hover_color="white",fg_color="#FFD700",text_color="#04042E")
      ...
      def validateInfo(self):
          if(self.TELSUP.get().isdigit()  and self.LASTNAMESUP.get()!="" and self.EMAILSUP.get() !="" ):
              ...
              result=addSupplier(newSup)
              if (result):
                  self.LASTNAMESUP.set("")
                  self.TELSUP.set("")
                  self.EMAILSUP.set("")
                  messagebox.showinfo("info", "The Supplier has been added successfully")
  
              else:
                  messagebox.showwarning("Warning", "The Supplier has not been added,maybe it is existed")
