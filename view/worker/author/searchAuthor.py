...
from view.worker.author.showInfo import ShowInfo
class Parent:
    def __init__(self,win):
        ...
        self.win.title("Search Author by number")
...
class ByNumber(Parent):
    def __init__(self,win):
        ...
        #widgets------------------------------
        label=CTkLabel(self.frame,text="Entre the Author Number",font=("Baskerville",18),pady=10 ,text_color="#FFD700")
        self.number=IntVar()
        ...
        btn=CTkButton(self.frame,text="Search",command=lambda:ShowInfo(win,self.number.get(),None,None),corner_radius=20,border_width=0,hover_color="white",fg_color="#FFD700",text_color="#04042E")
        #place---------------------------------------------------
        label.pack()
        entry.pack()
        btn.pack(pady=20)
...
class ByName(Parent):
    def __init__(self,win):
        ...
        self.space.pack(pady=20)
        #widgets------------------------------
        label=CTkLabel(self.frame,text="Entre the Author Last name",font=("Baskerville",18),pady=10 ,text_color="#FFD700")
        self.name=StringVar()
        ...
        btn=CTkButton(self.frame,text="Search",command=lambda:ShowInfo(win,None,self.name.get(),None),corner_radius=20,border_width=0,hover_color="white",fg_color="#FFD700",text_color="#04042E")
        #place---------------------------------------------------
        label.pack()
        entry.pack()
        btn.pack(pady=20)
class ByBookNumber(Parent):
    def __init__(self,win):
        ...
        entry=CTkEntry(self.frame,textvariable=self.numBook,width=150,height=30,corner_radius=10,border_width=0.5,border_color="#FFD700",fg_color="#0B0B41",font=("Baskerville",15))
        btn=CTkButton(self.frame,text="Search",command=lambda:ShowInfo(win,None,None,self.numBook.get()),corner_radius=20,border_width=0,hover_color="white",fg_color="#FFD700",text_color="#04042E")
        #place---------------------------------------------------
        label.pack()
        entry.pack()
        btn.pack(pady=20)